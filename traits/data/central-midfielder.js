...
window.POS_TRAITS['central-midfielder'] = {
  ...
  attrs:{
    ...
    cm_shuttle:   {cat:'motor', name:'The Shuttle',   def:'Slides up to press, drops back to screen — endless up-and-down.', sym:'returnloop'},
    ...
    // TECHNIQUE ◆
    cm_halfturn:  {cat:'technique', name:'Half-Turn', def:'Takes it on the spin and is already facing their goal.', sym:'halfturn'},
    cm_armour:    {cat:'technique', name:'Armour',    def:'Shields the ball with his body and keeps it under a challenge.', sym:'boxctrl'},
    ...
    cm_switchread:{cat:'vision', name:'The Overload', def:'Sees the far side is free while everyone crowds the ball.', sym:'eye'},
    ...
    cm_balance:   {cat:'vision', name:'The Balance',  def:'Weighs risk against safe, keep against go, in a single glance.', sym:'scales'},
    // IMPACT ⬡
    ...
    // SPIRIT ⯃
    cm_relentless:{cat:'spirit', name:'Relentless',   def:'Covers every blade of grass and still wants more at ninety.', sym:'reload'},
    cm_metronome: {cat:'spirit', name:'Metronome',    def:'Same steady, dependable influence for the full ninety minutes.', sym:'evenbars'},
    cm_baton:     {cat:'spirit', name:'The Baton',    def:'Takes charge, demands the ball and sets the rhythm of the side.', sym:'armband'},
    cm_bite:      {cat:'spirit', name:'The Bite',     def:'The competitive edge that wins the second ball and the duel.', sym:'fist'},
  ...
  archetypes:[
    ...
    {id:'maestro',  name:'The Maestro',  tag:'decides what — the decisive pass',  five:{motor:'cm_ride',      technique:'cm_receive',  vision:'cm_seam',      impact:'cm_linebreak', spirit:'cm_baton'}},
    {id:'carrier',  name:'The Carrier',  tag:'decides where — drives the line',   five:{motor:'cm_drive',     technique:'cm_escape',   vision:'cm_balance',   impact:'cm_through',   spirit:'cm_bite'}},
    ...
    {id:'destroyer',name:'The Destroyer',tag:'decides whether — the stop',        five:{motor:'cm_secondgear',technique:'cm_armour',   vision:'cm_clock',     impact:'cm_regain',    spirit:'cm_ice'}},
  ],
};
