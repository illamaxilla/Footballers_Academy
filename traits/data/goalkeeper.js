...
window.POS_TRAITS['goalkeeper'] = {
  ...
  attrs:{
    ...
    gk_quickset: {cat:'motor', name:'Quick Set',     def:'Tiny, rapid steps to be balanced and still the instant the striker pulls the trigger.', sym:'pistons'},
    gk_highspring:{cat:'motor', name:'High Spring',  def:'Rises off both feet to take the ball at its very highest point.', sym:'jump'},
    ...
    gk_parry:    {cat:'technique', name:'Parry',      def:'When he cannot hold it, he steers the spill wide of danger, never back into the box.', svg:'<path d="M5 20v-5.5a1.6 1.6 0 0 1 3.2 0V13a1.6 1.6 0 0 1 3.2 0v.4a1.6 1.6 0 0 1 3.2 0V19a2 2 0 0 1-2 2z"/><circle cx="18.5" cy="6.5" r="1.9"/><path d="M15 11c2.2-1 3.4-2.4 4-4.2" stroke-dasharray="1.4 1.7"/>'},
    ...
    gk_throw:    {cat:'technique', name:'The Release', def:'The fast bowled throw or rolled ball that finds a full-back before the shape resets.', sym:'launch'},
    ...
    // VISION ▪ — the read
    gk_anticip:  {cat:'vision', name:'Anticipation', def:'Reads the striker\'s hips and starts to move a beat before the ball is hit.', sym:'bulb'},
    ...
    gk_throughball:{cat:'vision', name:'Read The Line', def:'Sees the through-ball forming and decides — hold, or come and claim it — early.', sym:'eye'},
    ...
    gk_position: {cat:'vision', name:'Positioning',  def:'Always a yard off his line in the right place — half his saves are made before the shot.', sym:'crossgrid'},
    ...
    gk_sweep:    {cat:'impact', name:'Sweeper Cover', def:'Patrols the space behind a high line and mops up the ball before the runner gets there.', sym:'shieldtick'},
    gk_break:    {cat:'impact', name:'Launch The Break', def:'Turns a save into a chance — the first pass that catches them stretched and running.', sym:'longarc'},
    ...
    gk_consist:  {cat:'spirit', name:'Consistency',  def:'No horror shows, no cheap goals — the same dependable eight out of ten every week.', sym:'evenbars'},
  ...
  archetypes:[
    ...
    {id:'sentinel', name:'The Sentinel', tag:'commands and organises',       five:{motor:'gk_quickset',  technique:'gk_hands',    vision:'gk_wall',       impact:'gk_claim',    spirit:'gk_command'}},
    ...
    {id:'wall',     name:'The Wall',     tag:'fills the goal, rules the air',five:{motor:'gk_highspring',technique:'gk_bothfeet', vision:'gk_position',   impact:'gk_tipover',  spirit:'gk_dominate'}},
  ],
};
