...
window.POS_TRAITS['outside-midfielder'] = {
  ...
  attrs:{
    ...
    om_trackback: {cat:'motor', name:'Track-Back',      def:'Gets goalside to cover his full-back before the cross comes in.', sym:'returnloop'},
    ...
    om_whip:      {cat:'technique', name:'The Driven Cross', def:'Driven cross that bends away from the keeper across the six-yard box.', sym:'wallcurl'},
    om_channel:   {cat:'technique', name:'Channel Control', def:'Tidy first touch in the tight strip, back to goal with a man on him.', sym:'boxctrl'},
    om_bothfeet:  {cat:'technique', name:'Both Flanks', def:'Plays and delivers off either foot, from the left or the right.', sym:'bothfeet'},
    ...
    om_scan:      {cat:'vision', name:'Shoulder Check', def:'Checks his shoulder — knows the runner and the man inside before it comes.', sym:'eye'},
    om_timing:    {cat:'vision', name:'Pick The Moment',def:'Times the overlap so the flank is never left open behind him.', sym:'stopwatch'},
    om_cover:     {cat:'vision', name:'Cover The Space',def:'Knows when to hold width and when to pinch in behind his full-back.', sym:'scales'},
    ...
    om_beatman:   {cat:'impact', name:'Force The Cross',def:'Wins the wide one-v-one to get the cross away when the game is stuck.', sym:'progress'},
    ...
    om_relentless:{cat:'spirit', name:'Never Switches Off', def:'Sprints back to press the instant he loses it — never sulks, never hides.', sym:'reload'},
  ...
  archetypes:[
    {id:'workhorse',name:'The Workhorse', tag:'the flank workhorse',    five:{motor:'om_engine',    technique:'om_bothfeet', vision:'om_transition', impact:'om_cutback',   spirit:'om_workrate'}},
