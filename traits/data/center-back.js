...
window.POS_TRAITS['center-back'] = {
  ...
  attrs:{
    ...
    cb_engine:   {cat:'motor', name:'Iron Lungs',    def:'Still sprinting and still concentrating deep into stoppage time.', sym:'pistons'},
    // TECHNIQUE ◆
    ...
    cb_anticipate:{cat:'vision', name:'Sixth Sense', def:'Smells the through-ball early and is moving before it is played.', sym:'bulb'},
    cb_scan:     {cat:'vision', name:'Blind Side',    def:'Tracks the runner drifting off his blind side and never loses him.', sym:'radar'},
    ...
    cb_header:   {cat:'impact', name:'Aerial Command',   def:'Rises above the crowd and heads the cross clear before it drops.', sym:'header'},
    ...
    cb_ice:      {cat:'spirit', name:'Ice',          def:'Calm under a raining high ball with the whole stadium baying.', sym:'scales'},
    cb_switchedon:{cat:'spirit', name:'Switched On', def:'Ninety-five minutes of unbroken focus — one lapse costs a goal.', sym:'focusframe'},
  ...
  archetypes:[
    {id:'colossus', name:'The Colossus', tag:'wins every duel',          five:{motor:'cb_frame',    technique:'cb_clearance', vision:'cb_line',       impact:'cb_header',    spirit:'cb_frontfoot'}},
    ...
    {id:'sentinel', name:'The Sentinel', tag:'reads it first',          five:{motor:'cb_swivel',   technique:'cb_cushion',   vision:'cb_read',       impact:'cb_intercept', spirit:'cb_switchedon'}},
    {id:'libero',   name:'The Libero',   tag:'sweeps in behind',        five:{motor:'cb_recovery', technique:'cb_carry',     vision:'cb_trigger',    impact:'cb_lastditch', spirit:'cb_general'}},
  ],
};
