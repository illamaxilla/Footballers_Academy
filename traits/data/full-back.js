...
window.POS_TRAITS['full-back'] = {
  ...
  attrs:{
    ...
    fb_whip:      {cat:'technique', name:'The Whip',        def:'The out-swinging cross bent away from the keeper into the corridor.', sym:'wallcurl'},
    ...
    fb_cover:     {cat:'vision', name:'Cover Read',     def:'Slides in to cover the centre-half the instant he is dragged out.', sym:'radar'},
    ...
    fb_switch:    {cat:'impact', name:'The Switch',     def:'The raking diagonal that swings the attack to the far flank.', sym:'longarc'},
    ...
    fb_relentless:{cat:'spirit', name:'Relentless',    def:'Never stops running both ways, however the game is going.', sym:'flame'},
    ...
    fb_discipline:{cat:'spirit', name:'Discipline',    def:'Holds his shape and resists the wander when the trap is set.', sym:'level'},
  ...
  archetypes:[
    ...
    {id:'winger',   name:'The Winger',   tag:'the attacking full-back',    five:{motor:'fb_overlap',  technique:'fb_whip',      vision:'fb_timing',   impact:'fb_cutback',  spirit:'fb_relentless'}},
    {id:'sentinel', name:'The Sentinel', tag:'the defensive full-back',    five:{motor:'fb_recovery', technique:'fb_shield',    vision:'fb_showline', impact:'fb_lastditch',spirit:'fb_duel'}},
    {id:'architect',name:'The Architect',tag:'the inverted full-back',     five:{motor:'fb_gears',    technique:'fb_carry',     vision:'fb_underlap', impact:'fb_switch',   spirit:'fb_discipline'}},
  ],
};
